_base_ = [
    ...
    '../_base_/datasets/coco_detection_oil.py'
]
...
val_dataloader = dict(
    batch_size=4, num_workers=10, dataset=dict(pipeline=test_pipeline))
...
optim_wrapper = dict(
    _delete_=True,
    type='OptimWrapper',
    optimizer=dict(type='AdamW', lr=base_lr, weight_decay=0.03),
    paramwise_cfg=dict(
